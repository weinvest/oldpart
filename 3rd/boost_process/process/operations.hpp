...
#  include <boost_process/process/detail/posix_ops.hpp> 
#  include <stdlib.h> 
#  include <unistd.h> 
...
#  include <boost_process/process/detail/win32_ops.hpp> 
#  include <boost_process/algorithm/string/predicate.hpp> 
#  include <windows.h> 
#else 
